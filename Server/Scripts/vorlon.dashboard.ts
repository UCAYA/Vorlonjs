...
export module VORLON {
    export class Dashboard implements iwsc.VORLON.IWebServerComponent {
        ...
        public addRoutes(app: express.Express, passport: any): void {
            ...
            app.route(this.baseURLConfig.baseURL + '/dashboard/:sessionid/group/:groupId').get(vauth.VORLON.Authentication.ensureAuthenticated, this.dashboardWithGroup());
        ...
        private dashboardWithGroup() {
            return (req: express.Request, res: express.Response) => {
                res.render('dashboard', { baseURL: this.baseURLConfig.baseURL, title: 'Dashboard', sessionid: req.params.sessionid, clientid: "*", groupId: req.params.groupId });
            }
        }
